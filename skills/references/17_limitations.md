...
For UniFlight 1.0.4, agents should disclose relevant limitations rather than implying unsupported fidelity.
...
## Version drift
This skill targets 1.0.4. If a live checkout is newer:
